...
As long as your code block uses an info string like `python marimo`, marimo will treat it as a Python cell.
...
````md
```sql marimo query="uniformly_random_numbers" hide-output=true
